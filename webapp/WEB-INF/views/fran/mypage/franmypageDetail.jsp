    		...
    		<div class="card">
						...
						<div class="rowRight">
							<nav aria-label="breadcrumb" >
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">가맹점 마이페이지</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<!-- card-body 영역 -->
					...
					<div class="ImageCard">
						...
						<div class="empName"> 
							<h4 class="nameMargin">${employeeOne.fran_comnm }( ${employeeOne.fran_id} )</h4><br>				
							<span class="bold">가맹점주 ${employeeOne.fowner_nm }</span>
						</div>
					</div>
					<span class="empDetailTitle">상세정보</span>
					<input type="hidden" class="fran_id" value="${employeeOne.fran_id}">
					...
					<%-- 	<tr>
						...
						<tr>
							<th><span class="nes"></span>사업자번호</th>				
							<td>${employeeOne.bizrno }</td>						
						</tr>
							<tr>
							<th><span class="nes"></span>가맹점 사업자번호</th>				
							<td>${employeeOne.fran_bizrno }</td>						
						</tr>
						<tr>
							<th><span class="nes"></span> 주소</th>				
							<td>(${employeeOne.fran_zipno }) ${employeeOne.fran_baadd } ${employeeOne.fran_deadd }</td>					
						</tr>
						<tr>
							<th><span class="nones"></span>가입일자</th>				
							<td>${employeeOne.fran_srbde}</td>				
						</tr>
						<tr>
							<th><span class="nones"></span>이메일</th>			
							<td>${employeeOne.fowner_email }</td>
						</tr>	
							<tr>
							<th><span class="nones"></span>전화번호</th>			
							<td>${employeeOne.fowner_celno }</td>
						</tr>
						
						<tr>
							<th><span class="nes"></span>핀번호</th>				
							<td>${employeeOne.pin_no}</td>					
						</tr>
				</table>
				<a class="btn btn-primary floatRight register" type="submit" href="${cPath}/fran/mypage/modify?what=${employeeOne.fran_id}">수정</a>
			
				<a href="${cPath}/fran/mypage" class="btn btn-secondary floatRight" ><i class="bi bi-arrow-clockwise"></i>돌아가기</a>
					<!-- card-body 끝 -->
                </div>
    		<!-- card 끝 -->
    		</div>
