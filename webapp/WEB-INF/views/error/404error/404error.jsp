...
<title>Insert title here</title>
 <link href="${path}/resources/css/404css.css" rel="stylesheet" >
<script type="text/javascript" src="${path}/resources/js/404js/404js.js" ></script>

</head>
<body>
<svg class="me404" viewBox="0 0 3000 480">
