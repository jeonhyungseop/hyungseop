...
<!--                         <h3>예치금 조회</h3> -->
<!--                         <p class="text-subtitle text-muted">가맹본부 예치금조회</p> -->
<!--                     </div> -->
...
<!-- 								<span class="titleFont">가맹본부 검색</span> -->
                                ...
                                <table class="table table-hover dataTable-table" id="table1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable">내용</a></th>
    ...
    <!-- 검색 폼 -->
    <form id="searchForm" action="${cPath }/head/deposit">
    ...
    <script type="text/javascript">
        ...
        //검색
    	searchTable.find("[name='searchType']").val("${pagingVO.searchMap.searchType }");
...
//                                 msg += '카드 승인번호 : ' + rsp.apply_num;
       ...
       searchForm = $("#searchForm").ajaxForm({
        ...
        excelDownBtn.on("click", function(){
        	location.href = "${cPath }/head/deposit/excel";
        });
        
        <c:if test="${not empty msg}">
        	alert("${msg}");
        	location.href = "${cPath }/head/deposit";
        </c:if>
		</script>