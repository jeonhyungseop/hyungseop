	            ...
	            <div class="card">
	                <div class="card-header">
	                	<div class="row">
	                       ...
	                       <button id="delete" type="button" class="btn btn-light-secondary me-1 mb-1 float-end" value="${inven.prod_code }">삭제</button>
	...
	$('.delOK').on('click', function(){
		$.ajax({
			...
			success : function(resp) {
				...
				location.href = "${cPath}/head/inven"
			},
...
area.render();
$("#area").on("click", ".apexcharts-reset-icon", function(){
	chart.submit();
	console.log("dsa")
	area.render();
});
