...
<div id="app">
    	<section class="section">
    		...
    		<div class="card">
				...
				<!-- card-body 영역 -->
					<div class="card-body">
					<form:form  method="post" enctype="multipart/form-data" class="empForm" action="${cPath}/head/employee">
					<table class="table table-hover">
						<tr class="profileTR">
							<td rowspan="14" class="profileArea">
							<div class="image-container">
								 <img style="width: 255px;" id="preview-image" src="${cPath}/resources/images/logo/profileIMG.jpg">
								 <input class="form-control photo" name="emp_files" style="display: block;" type="file" id="input-image">
								 <span class="checkspan photospan"></span>
							</div>
							<%-- 	
								<div class="img">
									<img class="userAdd" src="${cPath}/resources/images/logo/user_white.png">
								</div> --%>
						...
						<tr>
							...
							<td><input class="form-control formWidth nameCheck" type="text" name="emp_nm" value="홍사원">
								<span class="namespan checkspan"></span>
							</td>				
						</tr>
						<tr>
							<th><span class="nes">*</span> 비밀번호</th>				
							<td><input class="form-control formWidth pwdCheck" value="qwe123!@#Q" type="password" name="emp_pass" placeholder="영문 대소문자,숫자 ,특수문자 포함  8~12자리 입력">
								<span class="pwdspan checkspan"></span>
							</td>				
						</tr>
						<tr>
							<th><span class="nones">*</span>생년월일</th>				
							<td><input value="1997-05-26" class="form-control formWidth birthCheck" type="date" name="emp_birtday">
						...
						<tr>
							...
							<td>
								<input type="text" value="06112" class="form-control postnum" id="postcode"placeholder="우편번호" name="emp_zipno"/>
						...
						<tr>
							...
							<td>
								<input type="text" value="서울 강남구 논현로123길 4-1 (논현동)" class="form-control" id="address" placeholder="주소" name="emp_baadd"/>
								<input type="text" class="form-control" id="detailAddress" placeholder="상세주소" name="emp_deadd"/>
								<span class="addressspan checkspan"></span>
							</td>				
						</tr>
						<tr>
							<th><span class="nes">*</span>이메일</th>				
							<td><input value="abcde@naver.com" class="form-control emailCheck formWidth" type="text" name="emp_email">
								<span class="emailspan checkspan"></span>
							</td>				
						</tr>
						<tr>
							<th><span class="nones">*</span>전화번호</th>			
							<td><input class="form-control telCheck formWidth" type="text" name="emp_telno" placeholder="- 제외하고 입력">
								<span class="telspan checkspan"></span>
							</td>
						</tr>	
						<tr>
							<th><span class="nes">*</span>핸드폰 번호</th>				
							<td><input value="01012345678" class="form-control celCheck formWidth" type="text" name="emp_celno" placeholder="- 제외하고 입력">
								<span class="celspan checkspan"></span>
							</td>	
						</tr>
						<tr>
							<th><span class="nes">*</span>입사일자</th>				
							<td><input value="2021-06-28" class="form-control formWidth hiredateCheck" type="date" name="emp_encpn">
						...
						<tr>
							...
							<td>
								<select class="form-control formWidth" name="emp_clsf_code">
									<option value="">기본직급</option>
									<c:if test="${not empty comcodeECL }">
	                               		<c:forEach items="${comcodeECL }" var="ecl">
	                               			<option class="comcodeEach" value="${ecl.com_code }">${ecl.com_code_nm }</option>
	                               		</c:forEach>
	                                 </c:if>
                                 </select>
							</td>				
						...
						<tr>
							...
							<td>
								<select class="form-control formWidth" name="dept_seq">
									<option value="">부서선택</option>
									<c:if test="${not empty deptList }">
	                               		<c:forEach items="${deptList }" var="dept">
	                               			<option class="deptEach" value="${dept.dept_seq }">${dept.dept_nm}</option>
	                               		</c:forEach>
	                                 </c:if>
                                 </select>
							</td>				
						...
						<tr>
							...
							<td>
								<select class="form-control formWidth empSeCheck" name="emp_se_code">
									<option value="">기본구분</option>
									<c:if test="${not empty comcodeESE }">
	                               		<c:forEach items="${comcodeESE }" var="ese">
	                               			<option class="seCodeEach" value="${ese.com_code }">${ese.com_code_nm }</option>
	                               		</c:forEach>
	                                 </c:if>
								</select>
								<span class="empSespan checkspan"></span>
							</td>				
						</tr>
						<tr>
							...
							<td>
								<select class="form-control bankSelect" name="emp_bnm">
									<option class="bankEach" value="">은행선택</option>
									<option class="bankEach" value="KB국민은행">KB국민은행</option>
									<option class="bankEach" value="KEB하나은행">KEB하나은행</option>
									<option class="bankEach" value="신한은행">신한은행</option>
									<option class="bankEach" value="우리은행">우리은행</option>
									<option class="bankEach" value="NH농협">NH농협</option>
									<option class="bankEach" value="IBK기업은행">IBK기업은행</option>
									<option class="bankEach" value="KDB산업은행">KDB산업은행</option>
									<option class="bankEach" value="한국씨티은행">한국씨티은행</option>
								</select>
								<input class="form-control banknum" value="1112222965413" type="text" name="emp_bacc" placeholder="계좌번호 -제외하고 입력">
 ...
 $(function(){
	...
	//부서구분
	$('.deptEach').each(function(idx, dept){
	...
	//직급구분
	$('.comcodeEach').each(function(idx, com){
	...
	//직원구분
	$('.seCodeEach').each(function(idx, se){
