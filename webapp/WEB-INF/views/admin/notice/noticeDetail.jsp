			...
			<div class="card-header">
				...
				<c:choose>
					<c:when test="${adminauth eq 'ok'}">
						<c:url value="/admin/notice/delete" var="deleteList">
							<c:param name="what" value="${board.board_seq }" />

						</c:url>

						<c:url value="/admin/notice/update" var="updateList">
							<c:param name="what" value="${board.board_seq }" />
						</c:url>
						<c:url value="/admin/notice" var="noticeList">
						</c:url>

						<a href="${deleteList}" class="btn btn-primary float-end pribtn">삭제</a>
					
						<a href="${noticeList}" class="btn btn-primary float-end pribtn">목록</a>
					</c:when>

					<c:when test="${authok eq 'OK'}">
						<c:url value="/head/notice/delete" var="deleteList">
							<c:param name="what" value="${board.board_seq }" />
						</c:url>


						<c:url value="/head/notice/update" var="updateList">
							<c:param name="what" value="${board.board_seq }" />
						</c:url>
						...
						<a href="${updateList}" id="modify"
							class="btn btn-primary float-end pribtn">수정</a>
