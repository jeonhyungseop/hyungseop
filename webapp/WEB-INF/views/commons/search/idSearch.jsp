            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                   <div class="auth-logo">
                    ...
                    <p class="auth-subtitle mb-3">Input your information and we will give an ID</p>
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>Find Password? <a href="${cPath}/search/pw" class="font-bold">Find Password</a>.
                        </p>
                    </div>
                </div>
            </div>
    		...
    		if(group != "" && checkEmail() 
    			...
    			$.ajax({
       		        ...
       		        success : function(data) {
       		            ...
       		            if (id == null) {
       		            	$(".idresult").text("등록된 회원이 없습니다.");
       		            	$(".idresult").attr("class", "idresult fail");
       		            } else {
       		            	$("#idForm").remove();
       		            	$(".idresult").attr("class", "idresult tracking-in-expand");
       		            	$(".idresult").text("회원님의 아이디는 [ " + id + " ] 입니다.");
       		            }
       		        }
       		    }); 
    		}
