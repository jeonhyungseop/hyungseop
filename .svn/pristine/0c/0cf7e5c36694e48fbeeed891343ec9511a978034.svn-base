...
<div id="app">
    	<section class="section">
    		...
    		<div class="card">
						...
						<div class="rowRight">
							<nav aria-label="breadcrumb" >
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">본부수정</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<!-- card-body 영역 -->
					<div class="card-body">
					<form:form  method="post" enctype="multipart/form-data" class="empForm" action="${cPath}/head/headmypage/modify">
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td><input class="form-control formWidth nameCheck" type="text" name="head_nm" value="${employeeOne.head_nm }">
								<input type="hidden" name="head_id" value="${employeeOne.head_id }">
								<span class="namespan checkspan"></span>
							
							</td>				
						</tr>
						<tr>
							<th><span class="nes"></span> 상호명</th>				
							<td><input class="form-control formWidth " type="text" name="head_comnm" value="${employeeOne.head_comnm }">
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control postnum" id="postcode"placeholder="우편번호" name="head_zipno" value="${employeeOne.head_zipno}"/>
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control" id="address" placeholder="주소" name="head_baadd" value="${employeeOne.head_baadd}"/>
								<input type="text" class="form-control" id="detailAddress" placeholder="상세주소" name="head_deadd" value="${employeeOne.head_deadd}"/>
								<span class="addressspan checkspan"></span>
							</td>				
						</tr>
						<tr>
							<th><span class="nes"></span>이메일</th>				 
							<td><input class="form-control emailCheck formWidth" type="text" name="head_email" value="${employeeOne.head_email }">
								<span class="emailspan checkspan"></span>
							</td>				
						</tr>
						<tr>
							<th><span class="nones"></span>전화번호</th>			
							<td><input class="form-control telCheck formWidth" type="text" name="head_telno" placeholder="- 제외하고 입력" value="${employeeOne.head_telno }">
							...
							<tr>
							<th><span class="nes"></span>담당직원</th>				
							<td><input class="form-control formWidth nameCheck2" type="text" name="head_chargernm" value="${employeeOne.head_chargernm }">
								<span class="namespan2 checkspan2"></span>
