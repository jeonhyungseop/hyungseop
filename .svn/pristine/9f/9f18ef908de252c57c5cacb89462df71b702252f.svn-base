...
.circleScaleBtn:hover::before {
    ...
    <div id="app">
                    ...
                    <div class="row">
                  	...
                  	<c:choose>
                       ...
                       <c:otherwise>
	                       	<div class="col-6 col-lg-3 col-md-12">
	                           <div class="card marginTOP">
	                               <div class="card-body px-3 py-4-5 dashRightArea goPosBtn circleScaleBtn">
	                                   <div class="row ">
	                                       	<span class="fontSet">POS 시작하기</span>
	                              		 </div>
	                          		</div>
	                     	  </div>
	                       </div>
              ...
              <!------------------------------ AREA0 ----------------------------------------->	
               ...
               <c:forEach items="${dashList}" var="dash">
               		<c:if test="${dash.dash_ord eq '3' }">
	               		<c:import url="/fran/main/${dash.dash_id }"/>
               		</c:if>
               </c:forEach>
        ...
        <!-- 검색 폼 -->
	  	<form id="searchNoticeForm" action="${cPath}/fran/main/C0005">
        ...
        $(function() {
        	...
        	$(".column").sortable({
	        	...
	        	update: function(event, ui) {    
	        			...
	        			$.ajax({
							url : "${cPath}/fran/main/changeFranDash",
							method : "post",
        ...
        //pos 시작하기 버튼 클릭 이벤트
        $(".goPosBtn").on("click",function(){
        	location.href= "${cPath}/fran/posorder";
        });
		
        //C0005
        //날짜 포멧팅
	$("#listNoticeBody tr").each(function(){
	...
	let listNoticeBody = $("#listNoticeBody");
