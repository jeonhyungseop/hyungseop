    		...
    		<div class="card">
				...
				<!-- card-body 영역 -->
					...
					<div class="ImageCard">
						...
						<div class="empName"> 
							<h4 class="nameMargin">${employeeOne.head_comnm }( ${employeeOne.head_id} )</h4><br>
							<span class="bold">가맹본부 대표 ${employeeOne.head_nm }</span>
						</div>
					</div>
					<span class="empDetailTitle">상세정보</span>
					<input type="hidden" class="empId" value="${employeeOne.head_id}">
					<table class="table table-hover">
						...
						<tr>
							...
							<td>(${employeeOne.head_zipno }) ${employeeOne.head_baadd } ${employeeOne.head_deadd }</td>					
						</tr>
						<tr>
							<th><span class="nones"></span>가입일자</th>				
							<td>${employeeOne.head_srbde}</td>				
						</tr>
						<tr>
							<th><span class="nones"></span>이메일</th>				
							<td> ${employeeOne.head_email }</td>				
						</tr>
						<tr>
							<th><span class="nones"></span>전화번호</th>			
							<td>${employeeOne.head_telno }</td>
						</tr>	
						<tr>
							<th><span class="nes"></span>담당직원</th>				
							<td>${employeeOne.head_chargernm }</td>			
						</tr>
						<tr>
							<th><span class="nes"></span>사업자번호</th>				
							<td> ${employeeOne.head_bizrno }</td>					
						</tr>
				</table>
				<a class="btn btn-primary floatRight register" type="submit" href="${cPath}/head/headmypage/modify?what=${employeeOne.head_id}">수정</a>

				<a href="${cPath}/head/main" class="btn btn-secondary floatRight" ><i class="bi bi-arrow-clockwise"></i>돌아가기</a>
					<!-- card-body 끝 -->
                </div>
    		<!-- card 끝 -->
    		</div>
